from Generate_standard_nodes import cn,Country_states
import random
import uuid

def generate_OUs_GPOs(driver,domain,computers,Country,users):
    with driver.session() as session:
        print("Creating Narrow OUs")
        # Creating root OUs
        states = Country_states(Country)
        Company_dept = ["IT","HR","SALES","MANAGEMENT","R&D","MARKTING","ACCOUNTING"] 
